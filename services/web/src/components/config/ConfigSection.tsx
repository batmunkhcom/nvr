...
const LABELS: Record<string, [string, string | undefined, "text" | "number" | "toggle" | "select", string[]?]> = {
  ...
  "ai.detection_model": ["Detection Model", "YOLOv8 ONNX model for object detection. n=nano(fast) s=small m=medium l=large x=xlarge. Larger = more accurate, more RAM/CPU. Restart AI engine to apply.", "select", ["yolov8n.onnx", "yolov8s.onnx", "yolov8m.onnx", "yolov8l.onnx", "yolov8x.onnx"]],
  "ai.summarization_model": ["Summarization Model", "Model name for AI summarization, e.g. gpt-4o-mini / llama3.2-vision.", "text"],
